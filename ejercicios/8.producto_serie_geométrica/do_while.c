...
int main() { // Función principal del programa
    ...
    int i = 0; // Variable para contar los términos calculados
    ...
    do {
        ...
        i++; // Incrementar el contador de términos calculados
    } while (i < n); // Repetir hasta que se calculen n términos
