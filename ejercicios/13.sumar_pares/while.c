...
int main() { // Función principal del programa
    ...
    int i = 2; // Inicialización del contador para el bucle while en 2
    ...
    // Calcular la suma de los números pares utilizando un bucle while
    while (i <= n) { // Bucle while para sumar los números pares desde 2 hasta n
